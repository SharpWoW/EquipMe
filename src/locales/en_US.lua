...
L["COMMANDS_LIST_HELP"] = "Lists available equipment sets"
L["COMMANDS_LIST_AVAILABLE"] = "Available equipment sets"
L["COMMANDS_LIST_SET"] = "%(id)s (%(name)q)"
...
L["OPTIONS_GENERAL_LOGLEVEL_SET"] = "New log level set to %(level)s"
